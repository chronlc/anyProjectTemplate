...
- Intended to be safe and deterministic: only runs well-known
    formatters/linters' autofix features.
"""
...
def make_backups():
    # create backups for tracked files that might change. We'll copy all
    # .py files under the project into backups with a timestamped subdir.
...
def main():
    ...
    write_report(report)
    print("Auto-fix report written to:", REPORT_PATH)
